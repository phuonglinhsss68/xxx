...
window.boot = function () {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'https://cdn.jsdelivr.net/gh/phuonglinhsss68/xxx@master/v055/src/project.dev.js' : 'https://cdn.jsdelivr.net/gh/phuonglinhsss68/xxx@master/v055/src/project.156e8.js';
        if (jsList) {
            jsList = jsList.map(function (x) {
                return 'https://cdn.jsdelivr.net/gh/phuonglinhsss68/xxx@master/v055/src/' + x;
            });
    ...
    cc.AssetLibrary.init({
        libraryPath: 'https://cdn.jsdelivr.net/gh/phuonglinhsss68/xxx@master/v055/res/import',
        rawAssetsBase: 'https://cdn.jsdelivr.net/gh/phuonglinhsss68/xxx@master/v055/res/raw-',
...
// main.1cf53.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
    ...
    if (isRuntime) {
        require('https://cdn.jsdelivr.net/gh/phuonglinhsss68/xxx@master/v055/src/settings.0102a.js');
        require('https://cdn.jsdelivr.net/gh/phuonglinhsss68/xxx@master/v055/src/cocos2d-runtime.js');
        require('jsb-adapter/engine/index.js');
    }
    else {
        require('https://cdn.jsdelivr.net/gh/phuonglinhsss68/xxx@master/v055/src/settings.0102a.js');
        require('https://cdn.jsdelivr.net/gh/phuonglinhsss68/xxx@master/v055/src/cocos2d-jsb.js');
...
if (window.document) {
    ...
    cocos2d.async = true;
    cocos2d.src = window._CCSettings.debug ? 'https://cdn.jsdelivr.net/gh/phuonglinhsss68/xxx@master/v055/cocos2d-js.js' : 'https://cdn.jsdelivr.net/gh/phuonglinhsss68/xxx@master/v055/cocos2d-js-min.c2b34.js';
